...
def myNetwork():
  ...
  r4 = net.addHost('r4', cls=Node, ip='192.168.2.0/24')
  r4.cmd('sysctl -w net.ipv4.ip_forward=1')
  r3 = net.addHost('r3', cls=Node, ip='10.0.1.0/24')
  r3.cmd('sysctl -w net.ipv4.ip_forward=1')

  info( '*** Add hosts\n')
  h1 = net.addHost('h1', cls=Host, ip='10.0.1.2', defaultRoute='via 10.0.1.0/24')
  h2 = net.addHost('h2', cls=Host, ip='10.0.1.4', defaultRoute='via 10.0.1.0/24')
  h3 = net.addHost('h3', cls=Host, ip='10.0.2.2', defaultRoute='via 10.0.2.0/24')
  h4 = net.addHost('h4', cls=Host, ip='10.0.2.4', defaultRoute='via 10.0.2.0/24')
  ...
  info("1\n")
  # r3 --> r4
  info(net["r3"].cmd("ip route add 10.0.2.0/24 via 192.168.1.4 dev r3-eth0"))
  # r4 --> r3 broken right now
